...
const Circles = () => {
  return (
    <>
      <div className="relative w-[85px] sm:w-[100px] h-[85px] sm:h-[100px]">
        <div className="flex -space-x-10 sm:-space-x-20 absolute bottom-0 left-0">
        ...
        <div className="flex -space-x-5 sm:-space-x-10 absolute top-0 right-0">
